...
const ChefDashboard = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      try {
        ...
        setStats(null);
        setToast({ message: 'Erreur de chargement du tableau de bord chef de projet.', type: 'error' });
      } finally {
        setLoading(false);
      }
    };
  ...
  if (!stats) return <div className="min-h-screen flex items-center justify-center text-red-600">Erreur de chargement du tableau de bord chef de projet.</div>;
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 max-w-4xl mx-auto p-8">
          <h2 className="text-3xl font-bold text-blue-700 mb-8 text-center">Tableau de bord Chef de Projet</h2>
          ...
          <div className="bg-white rounded shadow p-6 mb-8">
            <h3 className="text-xl font-semibold mb-4 text-blue-700">Projets gérés</h3>
            <ul>
              {stats.projets.map((p) => (
